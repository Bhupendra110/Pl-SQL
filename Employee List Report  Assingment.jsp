...
<report name="Employee List Report  Assingment" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[select *from SCOTT.emp;]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_EMPNO">
        <displayInfo x="1.37732" y="1.94995" width="1.24548" height="1.62695"
        />
        <dataItem name="EMPNO" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Empno">
          <dataDescriptor expression="SCOTT.emp.EMPNO"
           descriptiveExpression="EMPNO" order="1" width="22" precision="4"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ENAME" datatype="vchar2" columnOrder="12"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Ename">
          <dataDescriptor expression="SCOTT.emp.ENAME"
           descriptiveExpression="ENAME" order="2" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JOB" datatype="vchar2" columnOrder="13" width="9"
         defaultWidth="90000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Job">
          <dataDescriptor expression="SCOTT.emp.JOB"
           descriptiveExpression="JOB" order="3" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="MGR" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="60000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Mgr">
          <dataDescriptor expression="SCOTT.emp.MGR"
           descriptiveExpression="MGR" order="4" width="22" precision="4"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIREDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hiredate">
          <dataDescriptor expression="SCOTT.emp.HIREDATE"
        ...
        <dataItem name="SAL" oracleDatatype="number" columnOrder="16"
         ...
         columnFlags="33" defaultLabel="Sal">
          <dataDescriptor expression="SCOTT.emp.SAL"
           descriptiveExpression="SAL" order="6" width="22" scale="2"
           precision="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COMM" oracleDatatype="number" columnOrder="17"
         ...
         columnFlags="33" defaultLabel="Comm">
          <dataDescriptor expression="SCOTT.emp.COMM"
           descriptiveExpression="COMM" order="7" width="22" scale="2"
           precision="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPTNO" oracleDatatype="number" columnOrder="18"
         ...
         columnFlags="33" defaultLabel="Deptno">
          <dataDescriptor expression="SCOTT.emp.DEPTNO"
      ...
      <frame name="M_G_EMPNO_GRPFR">
        ...
        <repeatingFrame name="R_G_EMPNO" source="G_EMPNO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_SAL" source="SAL" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="4.00000" y="0.18750" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_COMM" source="COMM" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="5.25000" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEPTNO" source="DEPTNO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="9"/>
            <geometryInfo x="6.43750" y="0.18750" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_EMPNO_FTR">
          ...
          <field name="F_SumSALPerReport" source="SumSALPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            ...
            <geometryInfo x="4.00000" y="0.37500" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_SAL" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.00000" y="0.00000" width="1.25000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="custom6"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes"
          ...
          <text name="B_COMM" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.25000" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="custom6"/>
            <textSegment>
              <font face="helvetica" size="9" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.95801" y="0.25000" width="1.08386" height="0.16675"
        />
        <textSegment>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwwine" sectionTitle="Employee_List"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGEMPNOGRPFR148">
<table class="OraTable">
<caption> Employee_List </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPNO148" asArray="no"/> class="OraColumnHeader"> Empno </th>
   <th <rw:id id="HBENAME148" asArray="no"/> class="OraColumnHeader"> Ename </th>
   <th <rw:id id="HBJOB148" asArray="no"/> class="OraColumnHeader"> Job </th>
   <th <rw:id id="HBMGR148" asArray="no"/> class="OraColumnHeader"> Mgr </th>
   <th <rw:id id="HBHIREDATE148" asArray="no"/> class="OraColumnHeader"> Hiredate </th>
   <th <rw:id id="HBSAL148" asArray="no"/> class="OraColumnHeader"> Sal </th>
   <th <rw:id id="HBCOMM148" asArray="no"/> class="OraColumnHeader"> Comm </th>
   <th <rw:id id="HBDEPTNO148" asArray="no"/> class="OraColumnHeader"> Deptno </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPNO1481" src="G_EMPNO">
   <tr>
    <td <rw:headers id="HFEMPNO148" src="HBEMPNO148"/> class="OraCellNumber"><rw:field id="FEMPNO148" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
    <td <rw:headers id="HFENAME148" src="HBENAME148"/> class="OraCellText"><rw:field id="FENAME148" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
    <td <rw:headers id="HFJOB148" src="HBJOB148"/> class="OraCellText"><rw:field id="FJOB148" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
    <td <rw:headers id="HFMGR148" src="HBMGR148"/> class="OraCellNumber"><rw:field id="FMGR148" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
    <td <rw:headers id="HFHIREDATE148" src="HBHIREDATE148"/> class="OraCellText"><rw:field id="FHIREDATE148" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
    <td <rw:headers id="HFSAL148" src="HBSAL148"/> class="OraCellNumber"><rw:field id="FSAL148" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
    <td <rw:headers id="HFCOMM148" src="HBCOMM148"/> class="OraCellNumber"><rw:field id="FCOMM148" src="COMM" nullValue="&nbsp;"> F_COMM </rw:field></td>
    <td <rw:headers id="HFDEPTNO148" src="HBDEPTNO148"/> class="OraCellNumber"><rw:field id="FDEPTNO148" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALPerReport148" src="HBSAL148"/> class="OraTotalNumber">Total: <rw:field id="FSumSALPerReport148" src="SumSALPerReport" nullValue="&nbsp;"> F_SumSALPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
